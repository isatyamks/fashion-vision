"""
services/faiss/visualizer.py
----------------------------
Handles matplotlib visualizations for search results.
"""
import os
...
class FaissVisualizer:
    """Displays query images alongside their top retrieved product matches."""
    ...
    def show_result(
        ...
        """Display the query crop alongside its top matching product images."""
        n = len(top_matches) + 1
